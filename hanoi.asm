#Perla Marina García García is728149
#Paulina Valadez Fernández  is728412
...
#    hanoi(n - 1, origen, auxiliar, destino); 
#antes de llamar a la función guardo mis datos en el stack pointer para no perderlos
llamada1: addi sp, sp, -20 #push 
	...
	#modificar argumento
	addi a2, zero, 1#n=1
llamada2:jal hanoi  #ya modificados hago la 2da llamada recursiva
	#pop 
	lw ra, 0(sp)#dirección de regreso
	lw a2, 4(sp)#n
	lw a3, 8(sp)#origen
...
llamada3:sub a2, a2, t0 # n-1 
	...
	addi sp, sp, +20
	jal hanoi  #ya modificados hago la 3ra llamada recursiva
	#pop 
	lw ra, 0(sp)#dirección de regreso
	lw a2, 4(sp)#n
	lw a3, 8(sp)#origen
